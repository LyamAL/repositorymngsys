    ...
    return function r(o, s, l) {
        ...
        1: [function (t, e, n) {
            ...
            for (var i in a) {
                ...
                var o = /(\w+)2(\w+)/.exec(i), s = o[1], l = o[2];
            ...
            e = this, n = function () {
                ...
                function b(t) {
                    if (null == t._isValid) {
                        var e = v(t), n = a.call(e.parsedDateParts, function (t) {
                                return null != t
                            }),
                ...
                var U = /\d/, G = /\d\d/, q = /\d{3}/, Z = /\d{4}/, X = /[+-]?\d{6}/, J = /\d\d?/, $ = /\d\d\d\d?/,
                    K = /\d\d\d\d\d\d?/, Q = /\d{1,3}/, tt = /\d{1,4}/, et = /[+-]?\d{1,6}/, nt = /\d+/,
                    it = /[+-]?\d+/, at = /Z|[+-]\d\d:?\d\d/gi, rt = /Z|[+-]\d\d(?::?\d\d)?/gi,
                ...
                var gt = 0, mt = 1, pt = 2, vt = 3, bt = 4, yt = 5, xt = 6, _t = 7, kt = 8;
                ...
                function ye(t) {
                    ...
                    if (l) {
                        for (v(t).iso = !0, e = 0, n = pe.length; e < n; e++) if (pe[e][1].exec(l[1])) {
                            a = pe[e][0], i = !1 !== pe[e][2];
                            break
                        }
                ...
                function Me(t) {
                    if (t._f !== c.ISO_8601) if (t._f !== c.RFC_2822) {
                        t._a = [], v(t).empty = !0;
                ...
                function Se(t) {
                    ...
                    return t._locale = t._locale || ue(t._l), null === r || void 0 === o && "" === r ? y({nullInput: !0}) : ("string" == typeof r && (t._i = r = t._locale.preparse(r)), k(r) ? new _(de(r)) : (h(r) ? t._d = r : s(o) ? function (t) {
                        var e, n, i, a, r;
                ...
                function Ae(t) {
                    var e = R(t), n = e.year || 0, i = e.quarter || 0, a = e.month || 0, r = e.week || 0,
                ...
                function We(t, e) {
                    ...
                    var i = ((n[n.length - 1] || []) + "").match(Ye) || ["-", 0, 0], a = 60 * i[1] + M(i[2]);
                ...
                function qe(t, e, n, i) {
                    var a = e._milliseconds, r = Re(e._days), o = Re(e._months);
                ...
                var Ze = Ge(1, "add"), Xe = Ge(-1, "subtract");
                ...
                function en(t, e, n, i, a) {
                    ...
                    return null == t ? Bt(this, i, a).year : ((r = Et(t, i, a)) < e && (e = r), function (t, e, n, i, a) {
                        var r = Ht(t, e, n, i, a), o = zt(r.year, 0, r.dayOfYear);
                ...
                un.add = Ze, un.calendar = function (t, e) {
                    var n = t || Ce(), i = Ne(n, this).startOf("day"), a = c.calendarFormat(this, i) || "sameElse",
                    ...
                    }(t = R(t)), i = 0; i < n.length; i++) this[n[i].unit](t[n[i].unit]); else if (P(this[t = F(t)])) return this[t](e);
                    return this
                ...
                hn.calendar = function (t, e, n) {
                    ...
                    if (this._monthsParseExact) return function (t, e, n) {
                        ...
                        if (!this._monthsParse) for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; i < 12; ++i) r = p([2e3, i]), this._shortMonthsParse[i] = this.monthsShort(r, "").toLocaleLowerCase(), this._longMonthsParse[i] = this.months(r, "").toLocaleLowerCase();
                ...
                var _n = xn("ms"), kn = xn("s"), wn = xn("m"), Mn = xn("h"), Sn = xn("d"), Dn = xn("w"), Cn = xn("M"),
                    Pn = xn("y");
                ...
                var On = Tn("milliseconds"), In = Tn("seconds"), An = Tn("minutes"), Fn = Tn("hours"), Rn = Tn("days"),
                    Ln = Tn("months"), Yn = Tn("years");
                var Wn = Math.round, Nn = {ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11};
                var zn = Math.abs;
                ...
                function Hn() {
                    ...
                    var r = w(a / 12), o = a %= 12, s = i, l = e, u = t,
                        d = n ? n.toFixed(3).replace(/\.?0+$/, "") : "", h = this.asSeconds();
                    if (!h) return "P0D";
                    var c = h < 0 ? "-" : "", f = Vn(this._months) !== Vn(h) ? "-" : "",
                        g = Vn(this._days) !== Vn(h) ? "-" : "", m = Vn(this._milliseconds) !== Vn(h) ? "-" : "";
            ...
            i._set("bar", {
                ...
                e.controllers.bar = e.DatasetController.extend({
                    dataElementType: a.Rectangle, initialize: function () {
                        ...
                        var i = this, a = i.chart, r = i.getMeta(), o = i.getDataset(), s = t.custom || {},
                        ...
                        var t, e, n = this.getIndexScale(), i = this.getStackCount(), a = this.index,
                            r = n.isHorizontal(), o = r ? n.left : n.top, s = o + (r ? n.width : n.height), l = [];
                        ...
                        var n, i, a, r, o, s, l = this.chart, u = this.getMeta(), d = this.getValueScale(),
                            h = l.data.datasets, c = d.getRightValue(h[t].data[e]), f = d.options.stacked, g = u.stack,
                            m = 0;
                        if (f || void 0 === f && void 0 !== g) for (n = 0; n < t; ++n) (i = l.getDatasetMeta(n)).bar && i.stack === g && i.controller.getValueScaleId() === d.id && l.isDatasetVisible(n) && (a = d.getRightValue(h[n].data[e]), (c < 0 && a < 0 || 0 <= c && 0 < a) && (m += a));
            ...
            i._set("bubble", {
                ...
                t.controllers.bubble = t.DatasetController.extend({
                    dataElementType: a.Point, update: function (n) {
                        var i = this, t = i.getMeta().data;
                        ...
                        var n, i, a, r = this.chart, o = r.data.datasets[this.index], s = t.custom || {},
                            l = r.options.elements.point, u = g.options.resolve, d = o.data[e], h = {},
            ...
            i._set("doughnut", {
                    ...
                    labels: {
                        generateLabels: function (l) {
                            ...
                            return u.labels.length && u.datasets.length ? u.labels.map(function (t, e) {
                                var n = l.getDatasetMeta(0), i = u.datasets[0], a = n.data[e], r = a && a.custom || {},
                                    o = O.valueAtIndexOrDefault, s = l.options.elements.arc;
                                return {
                                    text: t,
                ...
                t.controllers.doughnut = t.controllers.pie = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: O.noop, getRingIndex: function (t) {
                        ...
                        var i = this, t = i.chart, e = t.chartArea, a = t.options, r = a.elements.arc,
                            o = e.right - e.left - r.borderWidth, s = e.bottom - e.top - r.borderWidth,
                            l = Math.min(o, s), u = {x: 0, y: 0}, d = i.getMeta(), h = a.cutoutPercentage,
                            c = a.circumference;
                        if (c < 2 * Math.PI) {
                            var f = a.rotation % (2 * Math.PI),
                                g = (f += 2 * Math.PI * (f >= Math.PI ? -1 : f < -Math.PI ? 1 : 0)) + c,
                                m = Math.cos(f), p = Math.sin(f), v = Math.cos(g), b = Math.sin(g),
                                ...
                                w = h / 100, M = _ ? -1 : Math.min(m * (m < 0 ? 1 : w), v * (v < 0 ? 1 : w)),
                                S = k ? -1 : Math.min(p * (p < 0 ? 1 : w), b * (b < 0 ? 1 : w)),
                                D = y ? 1 : Math.max(m * (0 < m ? 1 : w), v * (0 < v ? 1 : w)),
                                C = x ? 1 : Math.max(p * (0 < p ? 1 : w), b * (0 < b ? 1 : w)), P = .5 * (D - M),
                                T = .5 * (C - S);
                            l = Math.min(o / P, s / T), u = {x: -.5 * (D + M), y: -.5 * (C + S)}
                        }
                        ...
                        var i = this, a = i.chart, r = a.chartArea, o = a.options, s = o.animation,
                            l = (r.left + r.right) / 2, u = (r.top + r.bottom) / 2, d = o.rotation, h = o.rotation,
                            c = i.getDataset(),
                        ...
                        var v = t._model, b = t.custom || {}, y = O.valueAtIndexOrDefault,
            ...
            i._set("line", {
                ...
                t.controllers.line = t.DatasetController.extend({
                    datasetElementType: a.Line, dataElementType: a.Point, update: function (t) {
                        var e, n, i, a = this, r = a.getMeta(), o = r.dataset, s = r.data || [], l = a.chart.options,
                            u = l.elements.line, d = a.getScaleForId(r.yAxisID), h = a.getDataset(), c = f(h, l);
                        ...
                        var i, a, r = this, o = r.getMeta(), s = t.custom || {}, l = r.getDataset(), u = r.index,
                            d = l.data[e], h = r.getScaleForId(o.yAxisID), c = r.getScaleForId(o.xAxisID),
            ...
            i._set("polarArea", {
                    ...
                    labels: {
                        generateLabels: function (s) {
                            ...
                            return l.labels.length && l.datasets.length ? l.labels.map(function (t, e) {
                                var n = s.getDatasetMeta(0), i = l.datasets[0], a = n.data[e].custom || {},
                                    r = _.valueAtIndexOrDefault, o = s.options.elements.arc;
                                return {
                                    text: t,
                ...
                t.controllers.polarArea = t.DatasetController.extend({
                    dataElementType: a.Arc, linkScales: _.noop, update: function (n) {
                        var t, e, i, a = this, r = a.getDataset(), o = a.getMeta(), s = a.chart.options.startAngle || 0,
                        ...
                        var v = this.chart.options.elements.arc, b = t.custom || {}, y = _.valueAtIndexOrDefault,
                            x = t._model;
                        ...
                        var n = this.getDataset(), t = this.getMeta(), i = 0;
            ...
            "use strict";
            var i = t(26), a = t(41), u = t(46);
            i._set("radar", {scale: {type: "radialLinear"}, elements: {line: {tension: 0}}}), e.exports = function (t) {
                t.controllers.radar = t.DatasetController.extend({
                    datasetElementType: a.Line, dataElementType: a.Point, linkScales: u.noop, update: function (n) {
                        var i = this, t = i.getMeta(), e = t.dataset, a = t.data, r = e.custom || {},
                            o = i.getDataset(), s = i.chart.options.elements.line, l = i.chart.scale;
                        ...
                        var i = this, a = t.custom || {}, r = i.getDataset(), o = i.chart.scale,
                            s = i.chart.options.elements.point, l = o.getPointPositionForValue(e, r.data[e]);
                        ...
                        var a = this.chart.chartArea, r = this.getMeta();
            ...
            "use strict";
            var s = t(22), l = t(23), h = t(26), c = t(46), a = t(29), r = t(31), f = t(49), g = t(32), m = t(34),
                i = t(36);
            e.exports = function (u) {
                ...
                u.types = {}, u.instances = {}, u.controllers = {}, c.extend(u.prototype, {
                    construct: function (t, e) {
                        ...
                        var r = f.acquireContext(t, e), o = r && r.canvas, s = o && o.height, l = o && o.width;
                        ...
                        var o = this, t = o.options, s = o.scales || {}, e = [],
                        ...
                        t.scales && (e = e.concat((t.scales.xAxes || []).map(function (t) {
                            ...
                            var e = t.options, n = e.id, i = c.valueOrDefault(e.type, t.dtype);
                        ...
                        return c.each(r.data.datasets, function (t, e) {
                            var n = r.getDatasetMeta(e), i = t.type || r.config.type;
                        ...
                        var n = t.duration, i = t.lazy;
                        if (!1 !== g.notify(e, "beforeRender")) {
                            var a = e.options.animation, r = function (t) {
                            ...
                            if (a && (void 0 !== n && 0 !== n || void 0 === n && 0 !== a.duration)) {
                                var o = new s({
                                    ...
                                    render: function (t, e) {
                                        var n = c.easing.effects[e.easing], i = e.currentStep, a = i / e.numSteps;
                                        t.draw(n(a), a, i)
                                    },
                        ...
                        var e = this, n = e._listeners = {}, i = function () {
                ...
                t.DatasetController = function (t, e) {
                    ...
                    datasetElementType: null, dataElementType: null, initialize: function (t, e) {
                        ...
                        e._data !== i && (e._data && o(e._data, e), t = e, (a = i)._chartjs ? a._chartjs.listeners.push(t) : (Object.defineProperty(a, "_chartjs", {
                            ...
                            var n = "onData" + t.charAt(0).toUpperCase() + t.slice(1), i = a[t];
                            Object.defineProperty(a, t, {
                                configurable: !0, enumerable: !1, value: function () {
                                    var e = Array.prototype.slice.call(arguments), t = i.apply(this, e);
                        ...
                        var e = this.chart.data.datasets[t._datasetIndex], n = t._index, i = t.custom || {},
                            a = s.valueAtIndexOrDefault, r = s.getHoverColor, o = t._model;
                        t.$previousStyle = {
        ...
        }, {2: 2, 46: 46}], 28: [function (t, e, n) {
            "use strict";
            var i = t(2), a = t(26), g = t(46), l = t(34);
            e.exports = function () {
                function d(t, e, n) {
                    var i;
                ...
                function e(t, e, n) {
                    var i = document.defaultView, a = g._getParentNode(t), r = i.getComputedStyle(t)[e],
                        o = i.getComputedStyle(a)[e], s = h(r), l = h(o), u = Number.POSITIVE_INFINITY;
                ...
                g.configMerge = function () {
                    ...
                    var a = t.skip ? e : t, r = e, o = n.skip ? e : n,
                        ...
                        d = l / (s + l), h = i * (u = isNaN(u) ? 0 : u), c = i * (d = isNaN(d) ? 0 : d);
                    return {
                    ...
                    var n = Math.floor(g.log10(t)), i = t / Math.pow(10, n);
                    ...
                    var l = parseFloat(g.getStyle(r, "padding-left")), u = parseFloat(g.getStyle(r, "padding-top")),
                        d = parseFloat(g.getStyle(r, "padding-right")), h = parseFloat(g.getStyle(r, "padding-bottom")),
        ...
        }, {2: 2, 26: 26, 34: 34, 46: 46}], 29: [function (t, e, n) {
            "use strict";
            var i = t(46);
            ...
            function d(t, i, a, r) {
                ...
                return l(t, function (t) {
                    if (!a || t.inRange(i.x, i.y)) {
                        var e = t.getCenterPoint(), n = r(i, e);
            ...
            function h(t) {
                var a = -1 !== t.indexOf("x"), r = -1 !== t.indexOf("y");
                return function (t, e) {
                    var n = a ? Math.abs(t.x - e.x) : 0, i = r ? Math.abs(t.y - e.y) : 0;
            ...
            function a(i, t, e) {
                var n = s(t, i);
                e.axis = e.axis || "x";
                var a = h(e.axis), r = e.intersect ? u(i, n) : d(i, n, !1, a), o = [];
            ...
            e.exports = {
                modes: {
                    single: function (t, e) {
                    ...
                    }, label: a, index: a, dataset: function (t, e, n) {
                        var i = s(e, t);
                        n.axis = n.axis || "xy";
                        var a = h(n.axis), r = n.intersect ? u(t, i) : d(t, i, !1, a);
                        ...
                        var i = s(e, t);
                        n.axis = n.axis || "xy";
                        var a = h(n.axis), r = d(t, i, n.intersect, a);
            ...
            e.exports = {
                defaults: {}, addBox: function (t, e) {
                    ...
                    if (e) {
                        var i = e.options.layout || {}, a = N.options.toPadding(i.padding), r = a.left, o = a.right,
                            s = a.top, l = a.bottom, u = z(e.boxes, "left"), d = z(e.boxes, "right"),
                            h = z(e.boxes, "top"), c = z(e.boxes, "bottom"), f = z(e.boxes, "chartArea");
                        V(u, !0), V(d, !1), V(h, !0), V(c, !1);
                        var g = n - r - o, m = t - s - l, p = m / 2, v = (n - g / 2) / (u.length + d.length),
                            b = (t - p) / (h.length + c.length), y = g, x = m, _ = [];
            ...
            "use strict";
            var o = t(26), s = t(46);
            o._set("global", {plugins: {}}), e.exports = {
                _plugins: [], _cacheId: 0, register: function (t) {
                    ...
                    var i = [], a = [], n = t && t.config || {}, r = n.options && n.options.plugins || {};
            ...
            "use strict";
            var x = t(26), i = t(27), B = t(46), a = t(35);
            ...
            function w(t) {
                var e = B.valueOrDefault, n = x.global, i = e(t.fontSize, n.defaultFontSize),
            ...
            x._set("scale", {
                ...
                calculateTickRotation: function () {
                    var t = this, e = t.ctx, n = t.options.ticks, i = _(t._ticks), a = w(n);
                    e.font = a.font;
                ...
                fit: function () {
                    var t = this, e = t.minSize = {width: 0, height: 0}, n = _(t._ticks), i = t.options, a = i.ticks,
                        r = i.scaleLabel, o = i.gridLines, s = i.display, l = t.isHorizontal(), u = w(a),
                    ...
                    if (a.display && s) {
                        var c = B.longestText(t.ctx, u.font, n, t.longestTextCache), f = B.numberOfLabelLines(n),
                            g = .5 * u.size, m = t.options.ticks.padding;
                        if (l) {
                            t.longestLabelWidth = c;
                            var p = B.toRadians(t.labelRotation), v = Math.cos(p),
                                b = Math.sin(p) * c + u.size * f + g * (f - 1) + g;
                            e.height = Math.min(t.maxHeight, e.height + b + m), t.ctx.font = u.font;
                            var y = k(t.ctx, n[0], u.font), x = k(t.ctx, n[n.length - 1], u.font);
                ...
                _autoSkip: function (t) {
                    var e, n, i, a, r = this, o = r.isHorizontal(), s = r.options.ticks.minor, l = t.length,
                        u = B.toRadians(r.labelRotation), d = Math.cos(u), h = r.longestLabelWidth * d, c = [];
                ...
                draw: function (S) {
                    ...
                    if (C.display) {
                        var o = D.ctx, P = x.global, T = C.ticks.minor, t = C.ticks.major || T, O = C.gridLines,
                            e = C.scaleLabel, I = 0 !== D.labelRotation, A = D.isHorizontal(),
                            F = T.autoSkip ? D._autoSkip(D.getTicks()) : D.getTicks(),
                            s = B.valueOrDefault(T.fontColor, P.defaultFontColor), l = w(T),
                            u = B.valueOrDefault(t.fontColor, P.defaultFontColor), d = w(t),
                            R = O.drawTicks ? O.tickMarkLength : 0,
                            n = B.valueOrDefault(e.fontColor, P.defaultFontColor), i = w(e),
                            a = B.options.toPadding(e.padding), L = B.toRadians(D.labelRotation), Y = [],
                            W = D.options.gridLines.lineWidth, N = "right" === C.position ? D.left : D.right - W - R,
                        ...
                        if (B.each(F, function (t, e) {
                            if (!B.isNullOrUndef(t.label)) {
                                ...
                                var v = "middle", b = "middle", y = T.padding;
                                if (A) {
                                    var x = R + y;
                            ...
                            if (O.display && (o.save(), o.lineWidth = t.glWidth, o.strokeStyle = t.glColor, o.setLineDash && (o.setLineDash(t.glBorderDash), o.lineDashOffset = t.glBorderDashOffset), o.beginPath(), O.drawTicks && (o.moveTo(t.tx1, t.ty1), o.lineTo(t.tx2, t.ty2)), O.drawOnChartArea && (o.moveTo(t.x1, t.y1), o.lineTo(t.x2, t.y2)), o.stroke(), o.restore()), T.display) {
                                ...
                                var e = t.label;
                                if (B.isArray(e)) for (var n = e.length, i = 1.5 * l.size, a = D.isHorizontal() ? 0 : -i * (n - 1) / 2, r = 0; r < n; ++r) o.fillText("" + e[r], 0, a), a += i; else o.fillText(e, 0, 0);
                                o.restore()
                            }
                        }), e.display) {
                            var r, h, c = 0, f = M(e) / 2;
                        ...
                        if (O.drawBorder) {
                            ...
                            var m = D.left, p = D.right + W, v = D.top, b = D.bottom + W, y = B.aliasPixel(o.lineWidth);
            ...
            (e.exports = a.extend({
                initialize: function () {
                    ...
                    var e, n, i, a, r, o, s, l, u, d, h, c, f, g, m, p, v, b, y, x, _ = this, k = _._options,
                        w = _._model, M = _._model = Y(k), S = _._active, D = _._data,
                        C = {xAlign: w.xAlign, yAlign: w.yAlign}, P = {x: w.x, y: w.y},
                        T = {width: w.width, height: w.height}, O = {x: w.caretX, y: w.caretY};
                    if (S.length) {
                        M.opacity = 1;
                        var I = [], A = [];
                    ...
                    var i, a, r, o, s, l, u = n.caretSize, d = n.cornerRadius, h = n.xAlign, c = n.yAlign, f = t.x,
                    ...
                    var r = e.xAlign, o = e.yAlign, s = t.x, l = t.y, u = i.width, d = i.height, h = e.cornerRadius;
            ...
            i._set("global", {
                ...
                inLabelRange: function (t) {
                    ...
                    if (n) {
                        ...
                        for (; s < a;) a -= 2 * Math.PI;
                        for (; a < o;) a += 2 * Math.PI;
                        var l = o <= a && a <= s, u = r >= n.innerRadius && r <= n.outerRadius;
                        return l && u
                    }
                    return !1
            ...
            "use strict";
            var i = t(26), a = t(27), d = t(46), h = i.global;
            i._set("global", {
                elements: {
                    line: {
                        tension: .4,
                ...
                draw: function () {
                    var t, e, n, i, a = this._view, r = this._chart.ctx, o = a.spanGaps, s = this._children.slice(),
                        l = h.elements.line, u = -1;
            ...
            "use strict";
            var u = t(26), i = t(27), d = t(46), h = u.global.defaultColor;
            ...
            u._set("global", {
                ...
                inRange: function (t, e) {
                    ...
                    var e = this._view, n = this._model, i = this._chart.ctx, a = e.pointStyle, r = e.rotation,
                        o = e.radius, s = e.x, l = e.y;
            ...
            i._set("global", {
                ...
                draw: function () {
                    ...
                    if (o = l.horizontal ? (t = l.base, e = l.x, n = l.y - l.height / 2, i = l.y + l.height / 2, a = t < e ? 1 : -1, r = 1, l.borderSkipped || "left") : (t = l.x - l.width / 2, e = l.x + l.width / 2, a = 1, r = (n = l.y) < (i = l.base) ? 1 : -1, l.borderSkipped || "bottom"), u) {
                        var d = Math.min(Math.abs(t - e), Math.abs(n - i)), h = (u = d < u ? d : u) / 2,
                            c = t + ("left" !== o ? h * a : 0), f = e + ("right" !== o ? -h * a : 0),
                            g = n + ("top" !== o ? h * r : 0), m = i + ("bottom" !== o ? -h * r : 0);
                        c !== f && (n = g, i = m), g !== m && (t = c, e = f)
                    }
                    s.beginPath(), s.fillStyle = l.backgroundColor, s.strokeStyle = l.borderColor, s.lineWidth = u;
                    var p = [[t, i], [t, n], [e, n], [e, i]], v = ["bottom", "left", "top", "right"].indexOf(o, 0);
                    ...
                    return e = l(this) ? (t = n.x, (n.y + n.base) / 2) : (t = (n.x + n.base) / 2, n.y), {x: t, y: e}
                }, getArea: function () {
                    var t = this._view;
                        ...
                        if (!(isNaN(n) || n <= 0)) {
                            switch (t.save(), t.translate(i, a), t.rotate(r * Math.PI / 180), t.beginPath(), e) {
                                ...
                                case"rect":
                                    ...
                                    break;
                                case"rectRounded":
                                    var c = n / Math.SQRT2, f = -c, g = -c, m = Math.SQRT2 * n;
            ...
            var i, d = {
                noop: function () {
                    ...
                    var a, r, o;
                    if (d.isArray(t)) if (r = t.length, i) for (a = r - 1; 0 <= a; a--) e.call(n, t[a], a); else for (a = 0; a < r; a++) e.call(n, t[a], a); else if (d.isObject(t)) for (r = (o = Object.keys(t)).length, a = 0; a < r; a++) e.call(n, t[o[a]], o[a])
                    ...
                    for (i = (n = n || {}).merger || d._merger, a = 0; a < u; ++a) if (e = l[a], d.isObject(e)) for (s = 0, o = (r = Object.keys(e)).length; s < o; ++s) i(r[s], t, e, n);
                    return t
            ...
            e.exports = {
                toLineHeight: function (t, e) {
                    ...
                    var i, a, r;
                    for (i = 0, a = t.length; i < a; ++i) if (void 0 !== (r = t[i]) && (void 0 !== e && "function" == typeof r && (r = r(e)), void 0 !== n && o.isArray(r) && (r = r[n]), void 0 !== r)) return r
                }
            }
            ...
            "use strict";
            var f = t(46), g = "$chartjs", m = "chartjs-", p = m + "render-monitor", v = m + "render-animation",
            ...
            function l(t, e) {
                var n = f.getStyle(t, e), i = n && n.match(/^(\d+)(\.\d+)?px$/);
            ...
            function a(e, t, n) {
                var i, a, r, o, s, l, u, d, h = e[g] || (e[g] = {}), c = h.resizer = function (t) {
                    var e = document.createElement("div"), n = m + "size-monitor",
            ...
            e.exports = {
                id: "filler", afterDatasetsUpdate: function (t, e) {
                    ...
                    var n = e.meta.$filler;
                    if (n) {
                        var i = t.ctx, a = n.el, r = a._view, o = a._children || [], s = n.mapper,
            ...
            "use strict";
            var D = t(26), i = t(27), C = t(46), a = t(31), r = C.noop;
            ...
            var o = i.extend({
                initialize: function (t) {
                    ...
                    var e = this, n = e.options.labels || {}, t = C.callback(n.generateLabels, [e.chart], e) || [];
                    ...
                    var i = this, t = i.options, a = t.labels, e = t.display, r = i.ctx, n = D.global,
                        o = C.valueOrDefault, s = o(a.fontSize, n.defaultFontSize),
                        l = o(a.fontStyle, n.defaultFontStyle), u = o(a.fontFamily, n.defaultFontFamily),
                        d = C.fontString(s, l, u), h = i.legendHitBoxes = [], c = i.minSize, f = i.isHorizontal();
                    if (c.height = f ? (c.width = i.maxWidth, e ? 10 : 0) : (c.width = e ? 10 : 0, i.maxHeight), e) if (r.font = d, f) {
                        var g = i.lineWidths = [0], m = i.legendItems.length ? s + a.padding : 0;
                        ...
                        var p = a.padding, v = i.columnWidths = [], b = a.padding, y = 0, x = 0, _ = s + p;
                    ...
                    var h = this, c = h.options, f = c.labels, g = D.global, m = g.elements.line, p = h.width,
                        v = h.lineWidths;
                    if (c.display) {
                        var b, y = h.ctx, x = C.valueOrDefault, t = x(f.fontColor, g.defaultFontColor),
                            _ = x(f.fontSize, g.defaultFontSize), e = x(f.fontStyle, g.defaultFontStyle),
                            n = x(f.fontFamily, g.defaultFontFamily), i = C.fontString(_, e, n);
                        y.textAlign = "left", y.textBaseline = "middle", y.lineWidth = .5, y.strokeStyle = t, y.fillStyle = t, y.font = i;
                        var k = P(f, _), w = h.legendHitBoxes, M = h.isHorizontal();
                        b = M ? {x: h.left + (p - v[0]) / 2, y: h.top + f.padding, line: 0} : {
                            x: h.left + f.padding,
                            y: h.top + f.padding,
                            line: 0
                        };
                            ...
                            M ? p <= u + l && (d = b.y += S, b.line++, u = b.x = h.left + (p - v[b.line]) / 2) : d + S > h.bottom && (u = b.x = u + h.columnWidths[b.line] + f.padding, d = b.y = h.top + f.padding, b.line++), function (t, e, n) {
                                if (!(isNaN(k) || k <= 0)) {
                                    ...
                                    if (y.setLineDash && y.setLineDash(x(n.lineDash, m.borderDash)), c.labels && c.labels.usePointStyle) {
                                        var a = _ * Math.SQRT2 / 2, r = a / Math.SQRT2, o = t + r, s = e + r;
            ...
            e.exports = {
                id: "legend", _element: o, beforeInit: function (t) {
            ...
            "use strict";
            var _ = t(26), i = t(27), k = t(46), a = t(31), r = k.noop;
            _._set("global", {
                title: {
                    display: !1,
                    fontStyle: "bold",
            ...
            var o = i.extend({
                ...
                beforeFit: r,
                fit: function () {
                    var t = k.valueOrDefault, e = this.options, n = e.display,
                        i = t(e.fontSize, _.global.defaultFontSize), a = this.minSize,
                        r = k.isArray(e.text) ? e.text.length : 1, o = k.options.toLineHeight(e.lineHeight, i),
                ...
                draw: function () {
                    var t = this.ctx, e = k.valueOrDefault, n = this.options, i = _.global;
                    if (n.display) {
                        var a, r, o, s = e(n.fontSize, i.defaultFontSize), l = e(n.fontStyle, i.defaultFontStyle),
                            u = e(n.fontFamily, i.defaultFontFamily), d = k.fontString(s, l, u),
                            h = k.options.toLineHeight(n.lineHeight, s), c = h / 2 + n.padding, f = 0, g = this.top,
                            m = this.left, p = this.bottom, v = this.right;
                        ...
                        var b = n.text;
                        if (k.isArray(b)) for (var y = 0, x = 0; x < b.length; ++x) t.fillText(b[x], 0, y, a), y += h; else t.fillText(b, 0, 0, a);
                        t.restore()
                    }
                }
            });
            ...
            e.exports = {
                id: "title", _element: o, beforeInit: function (t) {
            ...
            e.exports = function () {
                var t = i.extend({
                    getLabels: function () {
                        ...
                        var u = i.height / r, d = u * (e - i.minIndex);
                        return a && (d += u / 2), i.top + Math.round(d)
                    }, getPixelForTick: function (t) {
                        return this.getPixelForValue(this.ticks[t], t + this.minIndex, null)
                    }, getValueForPixel: function (t) {
                        var e = this.options.offset, n = Math.max(this._ticks.length - (e ? 0 : 1), 1),
                            i = this.isHorizontal(), a = (i ? this.width : this.height) / n;
            ...
            "use strict";
            var i = t(26), h = t(46), a = t(34), r = t(35);
            e.exports = function (t) {
                var e = {position: "left", ticks: {callback: r.formatters.linear}}, n = t.LinearScaleBase.extend({
                    determineDataLimits: function () {
                        var o = this, s = o.options, l = o.chart, t = l.data.datasets, e = o.isHorizontal();
                        ...
                        if (void 0 === i && h.each(t, function (t, e) {
                            ...
                            h.each(t, function (t, e) {
                                ...
                                var a = d[n].positiveValues, r = d[n].negativeValues;
                                ...
                                var e = t.positiveValues.concat(t.negativeValues), n = h.min(e), i = h.max(e);
                        ...
                        var e = this.start, n = +this.getRightValue(t), i = this.end - e;
                        return this.isHorizontal() ? this.left + this.width / i * (n - e) : this.bottom - this.height / i * (n - e)
                    }, getValueForPixel: function (t) {
                        var e = this.isHorizontal(), n = e ? this.width : this.height,
            ...
            "use strict";
            var c = t(46), i = t(33), a = t(34), r = t(35);
            e.exports = function (h) {
                var t = {position: "left", ticks: {callback: r.formatters.logarithmic}}, e = i.extend({
                    determineDataLimits: function () {
                        var o = this, n = o.options, s = o.chart, t = s.data.datasets, e = o.isHorizontal();
                        ...
                        if (void 0 === i && c.each(t, function (t, e) {
                            ...
                            c.each(t, function (t, e) {
                                ...
                                s.isDatasetVisible(e) && l(a) && (void 0 === u[r] && (u[r] = []), c.each(t.data, function (t, e) {
                                    var n = u[r], i = +o.getRightValue(t);
                                    isNaN(i) || a.data[e].hidden || i < 0 || (n[e] = n[e] || 0, n[e] += i)
                                }))
                            }), c.each(u, function (t) {
                                if (0 < t.length) {
                                    var e = c.min(t), n = c.max(t);
                        ...
                        var t = this, e = t.options.ticks, n = c.valueOrDefault;
                        ...
                        var t = this, e = t.options.ticks, n = !t.isHorizontal(), i = {min: e.min, max: e.max},
                            a = t.ticks = function (t, e) {
                                var n, i, a = [], r = c.valueOrDefault,
                                    o = r(t.min, Math.pow(10, Math.floor(c.log10(e.min)))),
                                    s = Math.floor(c.log10(e.max)), l = Math.ceil(e.max / Math.pow(10, s));
                        ...
                        var e, n, i, a, r, o = this, s = o.options.ticks.reverse, l = c.log10,
                            u = o._getFirstTickValue(o.minNotZero), d = 0;
                        ...
                        var e, n, i, a, r = this, o = r.options.ticks.reverse, s = c.log10,
            ...
            "use strict";
            var i = t(26), _ = t(46), a = t(34), r = t(35);
            e.exports = function (t) {
                var v = i.global, e = {
                    display: !0,
                    animate: !0,
                ...
                function y(t) {
                    var e = t.options.pointLabels, n = _.valueOrDefault(e.fontSize, v.defaultFontSize),
                ...
                function p(t, e, n, i, a) {
                    return t === i || t === a ? {start: e - n / 2, end: e + n / 2} : t < i || a < t ? {
                        start: e - n - 5,
                        end: e
                    } : {start: e, end: e + n + 5}
                }
                ...
                function x(t, e, n, i) {
                    if (_.isArray(e)) for (var a = n.y, r = 1.5 * i, o = 0; o < e.length; ++o) t.fillText(e[o], n.x, a), a += r; else t.fillText(e, n.x, n.y)
                }
                ...
                var n = t.LinearScaleBase.extend({
                    setDimensions: function () {
                        ...
                        var i = _.min([t.height, t.width]), a = _.valueOrDefault(n.fontSize, v.defaultFontSize);
                        t.drawingArea = e.display ? i / 2 - (a / 2 + n.backdropPaddingY) : i / 2
                    }, determineDataLimits: function () {
                        var a = this, n = a.chart, r = Number.POSITIVE_INFINITY, o = Number.NEGATIVE_INFINITY;
                        ...
                        var t = this.options.ticks, e = _.valueOrDefault(t.fontSize, v.defaultFontSize);
                        ...
                        this.options.pointLabels.display ? function (t) {
                            var e, n, i, a = y(t), r = Math.min(t.height / 2, t.width / 2),
                                o = {r: t.width, l: 0, t: t.height, b: 0}, s = {};
                            ...
                            for (e = 0; e < h; e++) {
                                ...
                                } : {w: l.measureText(d).width, h: u}, t._pointLabelSizes[e] = n;
                                var c = t.getIndexAngle(e), f = _.toDegrees(c) % 360, g = p(f, i.x, n.w, 0, 180),
                        ...
                        var r = this, t = r.options, o = t.gridLines, s = t.ticks, l = _.valueOrDefault;
                        if (t.display) {
                            var u = r.ctx, d = this.getIndexAngle(0), h = l(s.fontSize, v.defaultFontSize),
                                e = l(s.fontStyle, v.defaultFontStyle), n = l(s.fontFamily, v.defaultFontFamily),
                            ...
                            _.each(r.ticks, function (t, e) {
                                ...
                                var e = t.ctx, n = t.options, i = n.angleLines, a = n.pointLabels;
                                ...
                                for (var h = b(t) - 1; 0 <= h; h--) {
                                    ...
                                    if (a.display) {
                                        ...
                                        var m = t.getIndexAngle(h), p = _.toDegrees(m);
            ...
            var o = t(26), p = t(46), i = t(33), a = t(34), m = Number.MIN_SAFE_INTEGER || -9007199254740991,
            ...
            function S(t, e) {
                ...
                var n = e.options.time, i = M(e.getRightValue(t), n);
            ...
            function C(t, e, n, i) {
                var a, r = i.time, o = r.unit || function (t, e, n, i) {
                        ...
                        for (a = _.indexOf(t); a < s - 1; ++a) if (o = (r = x[_[a]]).steps ? r.steps[r.steps.length - 1] : v, r.common && Math.ceil((n - e) / (o * r.size)) <= i) return _[a];
                        return _[s - 1]
                    }(r.minUnit, t, e, n), s = D(o), l = p.valueOrDefault(r.stepSize, r.unitStepSize),
                    u = "week" === o && r.isoWeekday, d = i.ticks.major.enabled, h = x[o], c = y(t), f = y(e), g = [];
            ...
            e.exports = function () {
                var t = i.extend({
                    initialize: function () {
                        ...
                        var t, e, n, i, a, r, o = this, s = o.chart, l = o.options.time, u = l.unit || "day", d = v,
                            h = m, c = [], f = [], g = [];
                        for (t = 0, n = s.data.labels.length; t < n; ++t) g.push(S(s.data.labels[t], o));
                        for (t = 0, n = (s.data.datasets || []).length; t < n; ++t) if (s.isDatasetVisible(t)) if (a = s.data.datasets[t].data, p.isObject(a[0])) for (f[t] = [], e = 0, i = a.length; e < i; ++e) r = S(a[e], o), c.push(r), f[t][e] = r; else c.push.apply(c, g), f[t] = g.slice(0); else f[t] = [];
                        ...
                        var t, e, n, i, a, r, o, s, l, u, d, h, c = this, f = c.min, g = c.max, m = c.options,
                            p = m.time, v = [], b = [];
                        ...
                        return c.min = f, c.max = g, c._unit = p.unit || function (t, e, n, i) {
                            ...
                            for (a = _.length - 1; a >= _.indexOf(e); a--) if (r = _[a], x[r].common && o.as(r) >= t.length) return r;
                        ...
                        var n = this.chart.data, i = this.options.time,
                            a = n.labels && t < n.labels.length ? n.labels[t] : "", r = n.datasets[e].data[t];
                        ...
                        var a = this.options, r = t.valueOf(), o = a.time.displayFormats, s = o[this._unit],
                            l = this._majorUnit, u = o[l], d = t.clone().startOf(l).valueOf(), h = a.ticks.major,
                            c = h.enabled && l && u && r === d, f = t.format(i || (c ? u : s)),
                            g = c ? h : a.ticks.minor, m = p.valueOrDefault(g.callback, g.userCallback);
                        return m ? m(f, e, n) : f
                        ...
                        var e = this.options.ticks, n = this.ctx.measureText(t).width, i = p.toRadians(e.maxRotation),
                        ...
                        var e = this.options.time.displayFormats.millisecond,
                            n = this.tickFormatFunction(y(t), 0, [], e), i = this.getLabelWidth(n),
                            a = this.isHorizontal() ? this.width : this.height, r = Math.floor(a / i);
                        return 0 < r ? r : 1
                    }
                });
